    ...
    return [
        ...
        },
        {
            ...
            keys: [
                ...
                ['workspace-jump-last', _('Trailing workspace')],
            ],
        },
        {
            title: _('Navigate'),
        ...
        },
        {
            ...
            keys: [
                ...
                ['window-move-last', _('Trailing workspace')],
            ],
        },
        {
        ...
        {
            title: _('Layout (this workspace)'),
            keys: [
                ['layout-set-tiled', _('Tile')],
                ['layout-set-stacked', _('Stack')],
                ['layout-set-floating', _('Float')],
                ['window-toggle-floating', _('Toggle floating window')],
        ...
        },
        {
            ...
            keys: [
                ['window-focus-left', _('Left')],
                ['window-focus-right', _('Right')],
                ['window-focus-up', _('Up')],
                ['window-focus-down', _('Down')],
            ],
        },
        {
            title: _('Move Window in Layout'),
            keys: [
                ['window-swap-left', _('Left')],
                ['window-swap-right', _('Right')],
                ['window-swap-up', _('Up')],
                ['window-swap-down', _('Down')],
            ],
        },
        {
            title: _('Panel'),
...
class QuickMenu extends PanelMenu.Button {
    ...
    _buildOverviewSection() {
        ...
        this._addSwitch(section, _('Launcher'), 'enable-launcher');
        this._addSwitch(section, _('Window management'), 'enable-tiling');
        this._addLayoutModeSelector(section);
    ...
    // The global layout mode as a segmented Tile | Stack | Float row
    // (same chrome as the tab bar above). Writes `layout-mode`, which the
    // tiler applies to every workspace; follows the setting live so a
    // change from Preferences, the launcher or another monitor's menu
    // shows here too.
    _addLayoutModeSelector(section) {
        const item = new PopupMenu.PopupBaseMenuItem({
            reactive: false,
            can_focus: false,
        });
        ...
        const bar = new St.BoxLayout({style_class: 'tessera-tabbar tessera-mode-bar'});
        ...
        for (const [mode, label] of [
            ...
            const button = new St.Button({
                style_class: 'tessera-tab tessera-mode-button',
                label,
                can_focus: true,
            });
            button.connect('clicked', () => {
                this._settingsManager.gsettings.set_string('layout-mode', mode);
            });
            bar.add_child(button);
        ...
        const sync = () => {
            const current = this._settingsManager.layoutMode;
        ...
        this._settingsManager.gsettings.connectObject(
            'changed::layout-mode', sync, item);
        this._settingsManager.gsettings.bind('enable-tiling', item, 'sensitive',
