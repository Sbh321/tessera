...
export class SettingsManager {
    ...
    /** The global default layout mode: 'tiled', 'stacked' or 'floating'. */
    get layoutMode() {
        const mode = this.gsettings.get_string('layout-mode');
        return ['tiled', 'stacked', 'floating'].includes(mode) ? mode : 'tiled';
    }
    ...
    get launcherEnableTabs() {
        return this.gsettings.get_boolean('launcher-enable-tabs');
    }
