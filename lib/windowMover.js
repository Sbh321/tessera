...
/**
 * Moves the focused window between workspaces, Hyprland-style. Pure action
 * methods with no state, signals, or timers -- there is deliberately
 * nothing to enable() or disable() here, so this module can never leak.
 * KeybindingManager dispatches into it; nothing else knows it exists.
 *
