...
/**
 * Owns the extension's keybindings: Super+1..9 / Super+Left / Super+Right
 * (switch workspace) and Shift+Super+1..9 / Shift+Super+Left / Right
 * (move the focused window; dispatched to lib/windowMover.js -- this
 * manager only registers accelerators and dispatches, it contains no
 * window logic).
 *
