...
export class KeybindingManager {
    constructor(settingsManager, windowMover, tilingManager, fullscreenManager, tools) {
        ...
        this._managedSchemas = [
            ...
            {
                settings: new Gio.Settings({schema_id: DESKTOP_WM_KEYBINDINGS_SCHEMA}),
    ...
    _bindAll() {
        this._savedStrvValues = this._managedSchemas.map(
        ...
        this._reassertSourceId = GLib.timeout_add(GLib.PRIORITY_DEFAULT, REASSERT_DELAY_MS, () => {
            for (const {settings, keys} of this._managedSchemas)
    ...
    _unbindAll() {
        ...
        if (this._savedStrvValues) {
            this._managedSchemas.forEach(({settings}, i) =>
