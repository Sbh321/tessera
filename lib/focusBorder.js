...
class FocusBorderManager extends St.Widget {
    ...
    _onFocusChanged() {
        ...
        // milliseconds; drawing a border around a 1x1 window and then
        // back around the real one is the flicker, so it is skipped and
        // the border simply stays where it was.
        if (window && HIGHLIGHTABLE_TYPES.has(window.window_type) && !isHelperSurface(window))
